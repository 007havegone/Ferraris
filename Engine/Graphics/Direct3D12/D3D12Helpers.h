...
constexpr struct {
	const D3D12_DEPTH_STENCIL_DESC1 disable{
		0,												// DepthEnable
...
public:
	...
	// add the transition barrier into the list
	...
	// add aligsing barrier into the list
...
struct d3d12_root_signature_desc : public D3D12_ROOT_SIGNATURE_DESC1
{
	constexpr explicit d3d12_root_signature_desc(const d3d12_root_parameter* parameters,
											u32 parameter_count,
											const D3D12_STATIC_SAMPLER_DESC* static_samples = nullptr,
											u32 sample_count = 0, D3D12_ROOT_SIGNATURE_FLAGS flags =
											D3D12_ROOT_SIGNATURE_FLAG_DENY_HULL_SHADER_ROOT_ACCESS |
											D3D12_ROOT_SIGNATURE_FLAG_DENY_DOMAIN_SHADER_ROOT_ACCESS |
											D3D12_ROOT_SIGNATURE_FLAG_DENY_GEOMETRY_SHADER_ROOT_ACCESS |
											D3D12_ROOT_SIGNATURE_FLAG_DENY_AMPLIFICATION_SHADER_ROOT_ACCESS |
											D3D12_ROOT_SIGNATURE_FLAG_DENY_MESH_SHADER_ROOT_ACCESS)
		: D3D12_ROOT_SIGNATURE_DESC1{ parameter_count, parameters, sample_count, static_samples, flags }
	{}
...
PSS(depth_stencil, D3D12_PIPELINE_STATE_SUBOBJECT_TYPE_DEPTH_STENCIL, D3D12_DEPTH_STENCILOP_DESC);
...
PSS(cached_pso, D3D12_PIPELINE_STATE_SUBOBJECT_TYPE_CACHED_PSO, D3D12_PIPELINE_STATE_FLAGS);
