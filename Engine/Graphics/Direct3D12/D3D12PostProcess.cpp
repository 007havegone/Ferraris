...
namespace ferraris::graphics::d3d12::fx {
...
bool
create_fx_pos_and_root_signature()
{
	...
	NAME_D3D12_OBJECT(fx_pso, L"Post-process FX PSO");
...
post_process(id3d12_graphics_command_list* cmd_list, D3D12_CPU_DESCRIPTOR_HANDLE target_rtv)
{
	...
	// NOTE: we don't need to clear render target, because each pixel will
