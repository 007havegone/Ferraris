...
namespace FerrarisEditor.Utilities
{
    ...
    {
        public static int INVALID_ID => -1; // need fix for arbitrary type for ID
    ...
    class DelayEventTimer
    {
        ...
        // this function call when the event is happen
        ...
        // once if the time interval greater then threshold,
        // call the event handle function
